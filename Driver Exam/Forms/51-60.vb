...
Public Class _51_60
    Private Sub BunifuImageButton2_Click(sender As Object, e As EventArgs) Handles BunifuImageButton2.Click
        ...
        If _number = 60 Then
            MetroMessageBox.Show(Me, vbCrLf & "Last Question Reached! Tick the SUBMIT button for evaluation." & vbCrLf & vbCrLf & vbCrLf & "©(PGLU-HRMD Series of 2018)", "Road Safety Program (Drivers Exam)", MessageBoxButtons.OK, MessageBoxIcon.Error)
        ElseIf _number > 0 And _number < 61 Then
            _number = _number + 1
            Select Case _number
                Case 51
...
#End Region
    ...
    Private Sub MetroButton2_Click(sender As Object, e As EventArgs) Handles MetroButton2.Click
        checklabels()
    End Sub
    Private Sub _51_60_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
