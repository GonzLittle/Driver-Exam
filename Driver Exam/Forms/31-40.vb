...
#Region "Radiobuttons"
    ...
    Private Sub rbtn7c_CheckedChanged(sender As Object, e As EventArgs) Handles rbtn7c.CheckedChanged
        ...
        End If
    End Sub
    Private Sub MaterialRadioButton1_CheckedChanged(sender As Object, e As EventArgs) Handles rbtn7d.CheckedChanged
        If rbtn7d.Checked = True Then
            Label17.Text = "D"
        End If
    End Sub
    '--------gb8------
    ...
    Private Sub _31_40_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
